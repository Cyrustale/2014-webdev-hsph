...
<?php colabs_main_before(); ?>
    <div class="row main-container">
        <div class="main-content col9">
			...
			<div class="entry">
				<h3><?php _e('Post Categories:', 'colabsthemes');?></h3>
				<ul >
			...
			if (get_categories( $args ))	{	
				?>
			<div class="entry">
				<h3><?php _e('Ad Categories:', 'colabsthemes');?></h3>
				<ul >
			...
			<?php }?>
			<div class="entry">
				<h3><?php _e('Ad Tags:', 'colabsthemes');?></h3>
				<p>
				<?php 
			...
			if (get_categories( $args ))	{	
				?>
			<div class="entry">
				<h3><?php _e('Ad Locations:', 'colabsthemes');?></h3>
				<ul >
				<?php wp_list_categories( $args ); ?>
				</ul>
			</div>
