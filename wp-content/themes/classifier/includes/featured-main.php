...
if(isset($colabs_options['colabs_slider_image'])) $colabs_slider_pos = $colabs_options['colabs_slider_image'];
...
?>
    ...
    <div class="featured-listing">
      ...
      <!--<h3 class="heading">Hot <?php // if( !empty($colabs_options['colabs_featured_header']) ) { echo stripslashes($colabs_options['colabs_featured_header']); }else{ _e('Featured Listing','colabsthemes'); } ?></h3>-->
      ...
      <ul class="slides">
        ...
        <li class="listing-slide slide-<?php echo $count; ?> post-slide-<?php echo $post->ID; ?>">
          <header>
            ...
            <?php colabs_image('width=743&height=318&size=featured-main'); ?>          
