...
<div class="entry-content">
  ...
  <form name="mainform" id="mainform" class="form_step" action="" method="post" enctype="multipart/form-data">
    ...
    <ol>
      ...
      <li>
        ...
        <div id="review"><strong>
            ...
            if ($total_cost > 0) echo colabs_pos_price($total_cost); else echo __('--', 'colabsthemes');
            ?>
        </strong></div>
      </li>
    ...
    <p class="terms">
			<?php _e('By clicking the proceed button below, you agree to our terms and conditions.','colabsthemes'); ?>
      <br />
    ...
    <p class="btn2">
      ...
      <input type="submit" name="step2" id="step2" class="btn btn-primary" value="<?php _e('Proceed ','colabsthemes'); ?> &rsaquo;&rsaquo;" />
    </p>
