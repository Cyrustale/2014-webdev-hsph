...
?>
   ...
   <h3><?php if ($_POST['total_cost'] > 0) { echo __('Final Step','colabsthemes'); } else { echo __('Membership Updated','colabsthemes'); } ?></h3>
    ...
    if ($order['total_cost'] > 0) :
        include_once (get_template_directory() . '/includes/gateways/gateway.php');
	
		//process the "free" orders on this page, the payment gateway orders will be processed on template-membership-buy.php
		else : 
