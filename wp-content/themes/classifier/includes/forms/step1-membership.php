            ...
            <?php
              ...
              ?>
                ...
                <tr class="<?php echo $rowclass.' '.$requiredClass; ?>">
                    ...
                    <td><input type="submit" name="step1" id="step1" class="btn btn-primary" onclick="document.getElementById('pack').value=<?php echo $result->pack_id; ?>;" value="<?php _e('Buy Now &rsaquo;&rsaquo;','colabsthemes'); ?>" style="margin-left: 5px; margin-bottom: 5px;" /></td>
                </tr>
