...
?>
            ...
            <form action="<?php echo $action; ?>" method="post" class="loginform" name="registerform" id="registerform">
                ...
                <p>
                    ...
                    <input tabindex="1" type="text" class="text" name="your_username" id="your_username" value="<?php if (isset($posted['your_username'])) esc_attr($posted['your_username']); ?>" />
                </p>

                <p>
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e('Email','colabsthemes') ?>&nbsp;:</label>
                    <input tabindex="2" type="text" class="text" name="your_email" id="your_email" value="<?php if (isset($posted['your_email'])) esc_attr($posted['your_email']); ?>" />
                </p>
