...
function colabs_login_form( $action = '', $redirect = '' ) {
	...
	<form action="<?php echo $action; ?>" method="post" class="loginform">
		...
		<p>
			...
			<input type="text" class="text" name="log" id="login_username" value="<?php if (isset($posted['login_username'])) esc_attr($posted['login_username']); ?>" />
		</p>
