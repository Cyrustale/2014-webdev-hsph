...
function colabs_coupons() {
    ...
    ?>
	    ...
	    // @todo Switch to
            ...
            if ( $results ) :
            ?>
                <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Creating your coupon.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
    ...
    ?>
        <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Deleting coupon.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
        <meta http-equiv="refresh" content="0; URL=?page=coupons">
    <?php
    break;
    default:
            ...
            <?php
              ...
              ?>
                <tr class="<?php echo $rowclass ?>">
                    ...
                    <td><?php if (($result->coupon_discount_type) == '%') echo number_format($result->coupon_discount,0) . '%'; else echo colabs_pos_price($result->coupon_discount); ?></td>
                    ...
                    <td style="text-align:center">
                        <a href="?page=coupons&amp;action=editcoupon&amp;id=<?php echo $result->coupon_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/edit.png" alt="<?php echo  _e('Edit coupon','colabsthemes') ?>" title="<?php echo _e('Edit coupon','colabsthemes') ?>" /></a>&nbsp;&nbsp;&nbsp;
                        <a onclick="return confirmBeforeDelete();" href="?page=coupons&amp;action=delete&amp;id=<?php echo $result->coupon_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/cross.png" alt="<?php echo _e('Delete coupon','colabsthemes') ?>" title="<?php echo _e('Delete coupon','colabsthemes') ?>" /></a>
                    </td>
                </tr>
              <?php
                $i++;
