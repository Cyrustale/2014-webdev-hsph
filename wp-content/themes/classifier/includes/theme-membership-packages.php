		...
		array(  'name' => __('Name', 'colabsthemes'),
               ...
               array(  'name' => __('Description','colabsthemes'),
                ...
                array(  'name' => __('Satisfies Membership Requirement', 'colabsthemes'),
                        'desc' => sprintf( __("If the &quot;<a href='%s'>Are Membership Packs Required to Purchase Ads</a>&quot; option under the Membership tab is set to yes, you should select yes.",'colabsthemes'), 'admin.php?page=colabsthemes#colabs-option-membershipsettings' ),
...
function colabs_ad_packs() {
    ...
    ?>
        ...
        if ( isset($_POST['submitted']) ) {
            ...
            if ($results !== false) :
            ?>
                <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Creating your ad package.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
    ...
    ?>
	    ...
	    $where = array(
            ...
            ?>
            <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Saving your changes.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
            <meta http-equiv="refresh" content="0; URL=?page=packages">
        <?php
        } else {
        ?>
    ...
    ?>
        <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Deleting ad package.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
        <meta http-equiv="refresh" content="0; URL=?page=packages">
    <?php
    break;
    default:
    ...
    ?>
              ...
              ?>
                <tr class="<?php echo $rowclass ?>">
                    ...
                    <td style="text-align:center">
                        <a href="?page=packages&amp;action=editpack&amp;type=ad&amp;id=<?php echo $result->pack_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/edit.png" alt="<?php echo  _e('Edit ad package','colabsthemes') ?>" title="<?php echo _e('Edit ad package','colabsthemes') ?>" /></a>&nbsp;&nbsp;&nbsp;
                        <a onclick="return confirmBeforeDelete();" href="?page=packages&amp;action=delete&amp;id=<?php echo $result->pack_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/cross.png" alt="<?php echo _e('Delete ad package','colabsthemes') ?>" title="<?php echo _e('Delete ad package','colabsthemes') ?>" /></a>
                    </td>
                </tr>
              <?php
        ...
        <table id="tblspacer" class="widefat fixed">
            ...
            ?>
                <tr class="<?php echo $rowclass ?>">
                    <td style="padding-left:10px;"><?php echo $i++ ?>.</td>
                    <td><strong style="color:#000"><?php echo $result->pack_id; ?></strong></td>
                    ...
                    <td style="text-align:center">
                        <a href="?page=packages&amp;action=editpack&amp;type=membership&amp;id=<?php echo $result->pack_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/edit.png" alt="<?php echo  _e('Edit ad package','colabsthemes'); ?>" title="<?php echo _e('Edit ad package','colabsthemes') ?>" /></a>&nbsp;&nbsp;&nbsp;
                        <a onclick="return confirmBeforeDelete();" href="?page=packages&amp;action=delete&amp;id=<?php echo $result->pack_id ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/cross.png" alt="<?php echo _e('Delete ad package','colabsthemes'); ?>" title="<?php echo _e('Delete ad package','colabsthemes') ?>" /></a>
                    </td>
                </tr>
              <?php
