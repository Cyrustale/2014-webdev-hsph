  ...
  <div class="row">
    ...
    <p class="copyright">
        ...
        if( $colabs_credits != 'true' ){ ?>
            ...
            <?php _e('Copyright', 'colabsthemes'); ?> &copy; <?php echo date_i18n('Y'); ?><?php _e(' All Rights Reserved', 'colabsthemes'); ?>. <!--<a href="<?php// echo home_url( '/' ); ?>"><?php// bloginfo('name'); ?></a>--> <?php _e(' Powered by', 'colabsthemes'); ?> <a href="http://www.websimpleworks.com">WSPI<!--ColorLabs &amp; Company--></a>. 
