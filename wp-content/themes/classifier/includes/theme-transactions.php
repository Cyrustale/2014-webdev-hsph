...
function colabs_transactions() {
    ...
    case 'setPaid':
            ...
            $wpdb->query( $update );
        ?>
        <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Updating transaction entry.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
    ...
    case 'delete':
            ...
            $wpdb->query( $delete );
        ?>
        <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Deleting transaction entry.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
        <meta http-equiv="refresh" content="0; URL=?page=transactions">
    <?php
    break;
    ...
    case 'activateMembership':
        ...
        ?>
        <p style="text-align:center;padding-top:50px;font-size:22px;"><?php _e('Activating membership plan.....','colabsthemes') ?><br /><br /><img src="<?php echo get_template_directory_uri(); ?>/images/loader.gif" alt="" /></p>
        <meta http-equiv="refresh" content="0; URL=?page=transactions">
    <?php
    break;
              ...
              ?>
                <tr class="<?php echo $rowclass ?>">
                    ...
                    <td style="text-align: center;">
                        <?php if ($result->payer_status == 'verified') { ?><img src="<?php echo get_template_directory_uri(); ?>/images/paypal_verified.gif" alt="" title="" /><br /><?php } ?>
                    ...
                    <td style="text-align:center">
                      <?php
                        echo '<a onclick="return confirmBeforeDelete();" href="?page=transactions&amp;action=delete&amp;id='. $result->id .'" title="'. __('Delete', 'colabsthemes') .'"><img src="'. get_template_directory_uri() .'/images/cross.png" alt="'. __('Delete', 'colabsthemes') .'" /></a>&nbsp;&nbsp;&nbsp;';
