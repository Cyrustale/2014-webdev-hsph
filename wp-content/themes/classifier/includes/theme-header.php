...
if (!function_exists('colabs_login_head')) {
    function colabs_login_head() {
        if (is_user_logged_in()) :
            ...
            <li><a href="<?php echo COLABS_DASHBOARD_URL ?>"><?php _e('Manage My Ads','colabsthemes'); ?></a></li>
        ...
        <?php endif; ?>
            <li><a href="<?php echo COLABS_ADD_NEW_URL ?>"><?php _e('Post an Ad','colabsthemes'); ?></a></li>
            <?php
    }
}
